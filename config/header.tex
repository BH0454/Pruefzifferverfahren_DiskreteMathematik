...
\usepackage{wrapfig}                % Für Textumflossene Bilder (wrapfigure)
...
\setlist[itemize]{itemsep=5pt, topsep=0pt, partopsep=0pt, parsep=0pt}

\setlist[enumerate]{itemsep=5pt, topsep=0pt, partopsep=0pt, parsep=0pt}
...
\RedeclareSectionCommand[beforeskip=0pt,afterindent=false,afterskip=0.5em]{section}
\RedeclareSectionCommand[beforeskip=0pt,afterindent=false,afterskip=0.5em]{subsection}
\RedeclareSectionCommand[beforeskip=0pt,afterindent=false,afterskip=0.5em]{subsubsection}
